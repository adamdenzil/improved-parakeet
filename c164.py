...
label_planet = Label(root,text="planet: ",bg = "lime")
label_planet_name = Label(root,font=("courier",18,"bold"),bg = "lime")
label_planet_image = Label(root,highlightthickness = 5,borderwidth=2,relief = SOLID,bg = "gold")
label_planet_gravity_radius = Label(root,font = ("castellar"),bg = "lime")
label_planet_info = Label(root,font = ("courier",10,"bold"),bg = "lime",wraplength=500)
